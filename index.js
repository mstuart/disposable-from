...
@param {number} milliseconds - How long to wait before invoking, in milliseconds.
...
@param {() => void} callback - The function to call on each interval.
@param {number} milliseconds - How long to wait between invocations, in milliseconds.
...
@param {() => void} setup - A function that performs setup and returns a teardown function.
